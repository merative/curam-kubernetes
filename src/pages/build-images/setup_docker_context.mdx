...
docker run --rm \
    ...
    icr.io/appcafe/websphere-liberty/26.0.0.3-full-java21-openj9-ubi-minimal \
...
docker run --rm \
    ...
    -e ANT_HOME=/tmp/ant \
    -e WLP_HOME=/opt/ibm/wlp \
    icr.io/appcafe/websphere-liberty/26.0.0.3-full-java8-ibmjava-ubi \
...
**Note:** As of Release 25.X.0, the IBM MQ Resource Adapter version used to verify this runbook is 9.4.3.0.
<p>&nbsp;</p>
...
1. Download the IBM MQ resource adapter from Fix Central.
   * Click this link:
   [IBM MQ Resource Adapter](https://www.ibm.com/support/fixcentral/swg/selectFixes?parent=ibm~WebSphere&product=ibm/WebSphere/WebSphere+MQ&release=9.4.3.0&platform=All&function=fixid&fixids=*IBM-MQ-Java-InstallRA*)
   * Find the resource adapter for your version of IBM MQ in the displayed list of available fixes. For example:

    ```
    release level: 9.4.3.0-IBM-MQ-Java-InstallRA
    Continuous Delivery: 9.4.3.0 IBM MQ Resource Adapter for use with Application Servers
    ```
