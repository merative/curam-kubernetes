...
```shell
docker run --rm -e LICENSE=view icr.io/appcafe/websphere-liberty/26.0.0.3-full-java21-openj9-ubi-minimal```
...
```shell
docker run --rm -e LICENSE=view icr.io/appcafe/websphere-liberty/26.0.0.3-full-java8-ibmjava-ubi
```
...
```shell
# IBM WebSphere MQ
docker run --rm -e LICENSE=view ibmcom/mq:9.4.3.0
```
