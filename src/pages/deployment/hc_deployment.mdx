...
```shell
docker run --rm -e LICENSE=view ibmcom/websphere-liberty:25.0.0.6-full-java21-openj9-ubi-minimal
```
...
```shell
docker run --rm -e LICENSE=view ibmcom/websphere-liberty:25.0.0.6-full-java8-ibmjava-ubi
```
