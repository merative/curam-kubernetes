...
5. Pull the IBM MQ docker image.
    ...
    ```
    docker pull cp.icr.io/cp/ibm-mqadvanced-server:9.3.5.1-r2
    ```

    The following output should be displayed:

    ```
    9.3.5.1-r1: Pulling from cp/ibm-mqadvanced-server
    (...)
    Status: Downloaded newer image for cp.icr.io/cp/ibm-mqadvanced-server:9.3.5.1-r2
