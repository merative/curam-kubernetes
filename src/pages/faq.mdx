...
Cúram supports hosting of containerized architectures on Azure Kubernetes Service (AKS), Amazon Elastic Kubernetes Service (EKS) and OpenShift. EKS is currently supported for production, development and test with Java 21.
